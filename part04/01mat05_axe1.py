...
'''
여러개의 axe 객체를 생성하여 서로 다른 그래프를 표현할 수 있다.
figure() 메서드로 그림의 틀을 만든후 figsize옵션으로 크기를 설정한다.
add_subplot() : 그림의 틀을 여러개로 분할한다. 분할된 틀을 axe객체
    라고한다.
...
# figure() 를 통해 2개의 서브플롯을 생성한다. 즉, 틀을 생성한다.
